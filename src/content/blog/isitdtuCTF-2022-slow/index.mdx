...
---
title: 'ISITDTU CTF 2022 - Slow'
description: 'A writeup on rev/Slow from ISITDTU CTF 2022.'
date: 2023/01/02
tags: ['writeup', 'reverse']
image: './isitdtu2022.jpg'
authors: ['fazect']
---
...
```asm showLineNumbers{1} /apply/ /components/
  mov     ecx, [ebp+arg_0]
  mov     edx, [ecx+10h]
  sub     edx, 1
  mov     eax, [ebp+arg_0]
...
```py title="solve/patch.py" showLineNumbers{1} /apply/ /components/
  from pwn import *
  context.arch = 'amd64'
